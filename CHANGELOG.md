...
- 65e230e: Add the experiment research command and remove research-run interview creation from the CLI.
...
- 9981480: Bump write-file-atomic to 8.0.0.
- a8f6492: Automate CLI release tagging and Dependabot release hygiene.
...
- Publish the current TypeScript CLI contract for analysis endpoints: `analysis_status` and `source_user_ids`.

### Added

- Require explicit release intent for CLI source/package changes through Changesets or a release version bump.
