...
4. Run relevant local checks (`bun run lint`, `bun run typecheck`, `bun test`, `bun run build`, plus any task-specific tests).
...
- `oriyn research {modes,list,ab-test,delphi,experiment,playtest}`
